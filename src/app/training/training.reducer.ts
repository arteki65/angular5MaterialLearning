...
export function trainingReducer(state = initState, action: trainingActions.TrainingActions) {
  switch (action.type) {
...
export const getIsOngoingTraining = createSelector(getTrainingState, (state: TrainingState) => state.activeTraining != null);
